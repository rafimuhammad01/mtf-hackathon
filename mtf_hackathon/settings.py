"""
Django settings for mtf_hackathon project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-64+f5dr^5j3i8e%4+@30c)u@22&()c-w^=wg5t&l$ig8nm(1gf')
...
ROOT_URLCONF = 'mtf_hackathon.urls'
...
WSGI_APPLICATION = 'mtf_hackathon.wsgi.application'
